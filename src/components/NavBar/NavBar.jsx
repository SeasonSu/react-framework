...
class NavBar extends Component {
  ...
  renderLeft() {
    ...
    return (
      <div className='top-menu-go-back panel-table-cell'>
  ...
  renderRight() {
    ...
    return (
      <div className='top-menu-go-home panel-table-cell'>
  ...
  render() {
    ...
    return (
      <AntdNavBar mode='light' icon={[< Icon key = '0' type = 'left' />]} rightContent={[< Icon key = '1' type = 'ellipsis' />]}>{title}</AntdNavBar>
    )
  }
}
